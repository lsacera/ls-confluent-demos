...
import { Home, Package, Users, Map, CreditCard, Network, RefreshCw } from 'lucide-react';
...
const Layout = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Payment Completion', path: '/payments', icon: CreditCard },
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Retail Streaming Analytics</h1>
                <p className="text-sm text-gray-500">Real-time data insights powered by Confluent</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              {/* Auto-refresh toggle */}
